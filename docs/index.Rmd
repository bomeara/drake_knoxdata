...
This is a presentation by [Brian O'Meara](http://brianomeara.info) for the [KnoxData group](https://www.meetup.com/knoxdata/) on March 19, 2020, on the [drake](https://github.com/ropensci/drake) package for making a workflow in R. Thank you to
Josh Rosenberg & Alex Pawlowski fo
